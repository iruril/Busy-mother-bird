							  ...
							  D3DXMATRIX rotation)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, lightDirection, ambientColor, diffuseColor, 
								 cameraPosition, specularColor, specularPower, rotation);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
										   ...
										   float specularPower, D3DXMATRIX rotation)
{
	HRESULT result;
	...
	D3DXMATRIX m_rotation = rotation;
	D3DXVECTOR3 m_lightDirection = lightDirection;

	//m_rotation = m_rotation * rotation;
	D3DXMatrixScaling(&m_rotation, -1.0f, 1.0f, -1.0f);

	D3DXVec3TransformCoord(&m_lightDirection, &m_lightDirection, &m_rotation);
